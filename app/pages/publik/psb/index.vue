  ...
  <div>
    <header class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
      ...
      <div class="flex justify-end gap-2 w-full md:w-auto">
        <NuxtLink to="/publik/psb/form-pendaftaran" class="text-[10px] px-4 py-2 glass-card btn-hover rounded-full uppercase tracking-widest text-white border border-white/5">
          Form Mendaftar
        </NuxtLink>
        <NuxtLink to="/publik/psb/rekap-pendaftar" class="text-[10px] px-4 py-2 glass-card btn-hover rounded-full uppercase tracking-widest text-white border border-white/5">
          Rekap Pendaftar
        </NuxtLink>
      </div>
    </header>
