  ...
  <div class="space-y-6">
    <header class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
      ...
      <div class="flex justify-end gap-2 w-full md:w-auto">
        <NuxtLink to="/publik/psb/form-pendaftaran" class="glass-card btn-head">Input Baru</NuxtLink>
        <NuxtLink to="/" class="glass-card btn-head">Gate Publik</NuxtLink>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
      <NuxtLink to="/publik/psb/form-pendaftaran"
        ...
        <div class="relative z-10 flex items-start gap-5"> 
          ...
          <div>
            <h3 class="text-lg font-semibold mb-1 text-slate-200">Input Baru</h3>
            <p class="text-slate-400 text-sm leading-relaxed mb-1">Klik disini untuk input baru data calon santri</p>
          </div>
        </div>
      ...
      <NuxtLink to="/internal/psb/pendaftar"
        ...
        <div class="relative z-10 flex items-start gap-5"> 
          ...
          <div>
            ...
            <p class="text-slate-400 text-sm leading-relaxed">Klik disini untuk audit data santri baru</p>
          </div>
        </div>
        <div class="absolute -right-4 -bottom-4 text-8xl opacity-[0.03] group-hover:opacity-[0.07] transition-opacity duration-500">📂</div>
      </NuxtLink>
