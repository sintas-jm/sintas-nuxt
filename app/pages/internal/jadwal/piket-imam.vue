    ...
    <div v-if="isEditModalOpen" class="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
      <div class="glass-card p-6 rounded-3xl w-full max-w-md border border-orange-500/30">
        ...
        <div class="space-y-4 text-left">
          <div>
            <label class="text-[10px] text-slate-500 uppercase tracking-widest block mb-1">Imam Utama</label>
          ...
          <div>
            <label class="text-[10px] text-slate-500 uppercase tracking-widest block mb-1">Imam Cadangan</label>
          ...
          <div>
            <label class="text-[10px] text-slate-500 uppercase tracking-widest block mb-1">Keterangan</label>
